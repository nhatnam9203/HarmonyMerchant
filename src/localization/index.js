const localization = {
  en: {
    ...
    PosDes:
      "Pay and tip your stylist from anywhere - even if you forget your cards! ",
    MarketingDes: "Get exclusive deals from all your favorite stores!",
    ReportDes:
      "I thought the last feature for Consumer App was Peer-to-Peer. What is Report and Manager?",
    "Principal Des":
