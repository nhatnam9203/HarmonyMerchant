const localization = {
    ...
    'vi': {
        ...
        'Federal Tax Id': 'Thuế liên bang',
        'SAVE': 'LƯU',
        'Business Address': 'Địa chỉ DN',
        'Business Name': 'Tên doanh nghiêp',
        'Auto lock screen after': 'Khoá màn hình sau',
        'Auto close at': 'Tự động tắt ',
        'Language': 'Ngôn ngữ',
        'MARKETING': 'Uu dai',
