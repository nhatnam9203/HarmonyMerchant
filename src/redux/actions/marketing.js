...
export function getBannerMerchant(
  merchantId,
  isLoading = true,
  isRefresh = false
) {
...
export function updatePromotionByMerchant(
  body,
  promotionId = 1,
  isSendNoti = true
) {
...
export function getPromotionByAppointment(
  appointmentId,
  isBlock = false,
  isAppointmentItem = false
) {
  return {
...
export function customPromotion(
  discountPercent,
  discountFixtom,
  discountByOwner,
  appointmentid,
...
export function customPromotionItem(
  discountPercent,
  discountFixtom,
  appointmentid,
  bookingproductid
...
export function deletePromotionById(promotionId) {
  return {
