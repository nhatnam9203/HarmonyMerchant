...
export function getGroupAppointmentById(
  id,
...
export function addItemIntoAppointment(
  body,
  appointmentId,
  isGroup = false,
  isBlock = false
...
export function addItemIntoMultiAppointment(
  body,
  appointmentId,
  mainAppointmentId,
  isGroup = false,
...
export function removeItemIntoAppointment(
  body,
  appointmentId,
  isGroup = false,
  isBlock = false
...
export function paymentAppointment(
  groupId,
  method,
  amount,
...
export function createAnymousAppointment(
  merchantId,
  userId = 0,
  customerId = 0,
  staffId = 0,
...
export function createBlockAppointment(
  merchantId,
  fromTime = new Date(),
  userId = 0,
  customerId = 0,
...
export function createAppointmentWaiting(
  merchantId,
  fromTime = new Date(),
  userId = 0,
  customerId = 0,
...
export function getBlockAppointmentById(
  appointmentId,
  isGetBookingGroupId = false
) {
  return {
...
export function cancleAppointment(
  appointmentId,
  merchantId,
  userId,
  isBlock = false,
  isCancelManyAppointment = false
) {
  return {
...
export function updateProductInAppointment(
  appointmentId,
  body,
  isGroup = true
) {
...
export function getCustomerBuyAppointment(
  phoneNumber,
  customerInfoLocal = {
    customerId: 0,
    firstName: "",
...
export function getGiftCardsActiveList(
  keySearch = "",
  page = 1,
  isShowLoading = true,
