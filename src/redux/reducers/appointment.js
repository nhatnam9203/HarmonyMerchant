...
function appointmentReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case "BOOKING_A_APPOINTMENT_FROM_CALENDAR_SUCCESS":
      return {
        ...
        appointmentIdBookingFromCalendar:
          action?.appointmentIdBookingFromCalendar,
      };
    ...
    case "GET_BLOCK_APPOINTMENT_BY_ID_SUCCESS":
      return {
        ...state,
        blockAppointments: mergeBlockAppointment([...state.blockAppointments], {
          ...action.payload,
        }),
        isLoadingGetBlockAppointment: false,
      };
    ...
    case "CANCEL_APPOINTMENT":
      return {
        ...
        isLoadingRemoveBlockAppointment:
          action.isBlock && !action.isCancelManyAppointment ? true : false,
      };
    ...
    case "REMOVE_BLOCK_APPOINTMENT_IN_REDUX":
      return {
        ...state,
        isLoadingRemoveBlockAppointment: false,
        blockAppointments: removeBlockAppointment(
          [...state.blockAppointments],
          action.payload
        ).data,
        idNextToAppointmentRemove: removeBlockAppointment(
          [...state.blockAppointments],
          action.payload
        ).indexExist,
      };
    case "ADD_BLOCK_APPOINTMENT_REF":
      return {
        ...state,
        blockAppointments_Ref: [...state.blockAppointments_Ref].push(
          action.payload
        ),
      };
    ...
    case "UPDATE_CUSTOMER_ID_BUY_APPOINTMENT":
      return {
        ...state,
        customerInfoBuyAppointment: {
          ...state.customerInfoBuyAppointment,
      ...
      return {
        ...
        giftCardsList:
          action?.currentPage === 1
            ? action.payload
            : state.giftCardsList.concat(action.payload),
    ...
    case "VISIBLE_POPUP_PAYMENT_CONFIRM":
      return {
        ...state,
        visiblePopupPaymentConfirm: action.payload,
      };
    case "LOGOUT_APP":
      return {
        ...initialState,
