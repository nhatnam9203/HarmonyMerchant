...
import { ButtonNormal, ButtonGradientWhite } from '@shared/components';
...
const log = (obj, message = '') => {
  Logger.log(`[DialogTimeKeeping] ${message}`, obj);
};
...
export const DialogTimeKeeping = React.forwardRef((props, ref) => {
    ...
    <View>
      ...
      >
        <View style={styles.container}>
          ...
          <Text style={styles.title}>{t('Enter PIN code')}</Text>
          <View style={styles.marginVertical} />
