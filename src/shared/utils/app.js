...
export const CustomerGroupTypes = [
  { label: 'Customer Group Type All', value: -1 },
  { label: 'Customer Group Type Normal', value: 0 },
  { label: 'Customer Group Type Vip', value: 1 },
  { label: 'Customer Group Type Blacklist', value: 2 },
];
