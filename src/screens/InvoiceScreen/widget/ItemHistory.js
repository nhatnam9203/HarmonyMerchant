...
class ItemHistory extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={{ minHeight: scaleSize(70), borderBottomColor: '#C5C5C5', borderBottomWidth: 1 }} >
                <View style={{ flex: 1.4, flexDirection: 'row' }} >
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }} >
                        <Text style={{ color: '#404040', fontSize: scaleSize(14) }} >
                            {formatWithMoment(data?.createdAt, 'MM/DD/YYYY')}
                        </Text>
                        <Text style={{ color: '#404040', fontSize: scaleSize(14), marginLeft: scaleSize(16) }} >
                ...
                <View style={{ flex: 1 }} >
                    ...
                    {
                        data?.reason && <Text style={{ color: '#404040', fontSize: scaleSize(14) }} >
                            {`Reason: ${data?.reason}`}
                        </Text>
                    }
