    ...
    this.setState({
      customerInfo: {
        ...
        addressPost: {
          ...
          state:
            customer.addressPost.state === 0
              ? ''
              : getNameStateById(stateCity, customer.addressPost.state),
  ...
  saveCustomerInfo = () => {
    ...
    for (let i = 0; i <= arrayKey.length - 1; i++) {
      ...
      if (
        ...
        !isValidDate(customerInfo.birthdate)
      ) {
        keyError = 'birthdate';
        break;
      }
    ...
    if (keyError != '') {
      ...
      const temptCustomerInfo = {
        ...
        birthdate: customerInfo?.birthdate
          ? stringToDate(customerInfo?.birthdate)
          : null,
      };
    ...
    return (
      <View style={{ flex: 1, paddingHorizontal: scaleSzie(10) }}>
        ...
        >
          ...
          {isVip ? (
            <Button
              onPress={this.changeCustomerStatus}
              style={{
                width: scaleSzie(85),
                height: scaleSzie(28),
            ...
            >
              ...
              {visibleChangeStatus ? (
                <Image
                  source={ICON.white_drpup_status_customer}
                  style={{ width: scaleSzie(18), height: scaleSzie(18) }}
                />
              ) : (
                <Image
                  source={ICON.white_drpdown_status_customer}
                  style={{ width: scaleSzie(18), height: scaleSzie(18) }}
                />
              )}
            </Button>
            ...
            >
              ...
              >
                <Dropdown
                  ...
                  value={gender}
                  onChangeText={(value) =>
                    this.updateCustomerInfo('gender', value)
                  }
                  containerStyle={{
                    borderWidth: 1,
                    borderColor: '#C5C5C5',
          ...
          <View style={{ flex: 1 }}>
            ...
            >
              ...
              >
                ...
                >
                  <TextInputMask
                    ...
                    value={birthdate}
                    onChangeText={(value) =>
                      this.updateCustomerInfo('birthdate', value)
                    }
                  />
                  {birthdate ? (
                    <Button
                    ...
                    >
                      <Image
                        source={ICON.clear_input_customer_info}
              ...
              >
                ...
                >
                  <TextInput
                    ...
                    value={city}
                    onChangeText={(value) =>
                      this.updateCustomerInfo('city', value, 'addressPost')
                    }
                  ...
                  {city ? (
                    <Button
                      onPress={() =>
                        this.updateCustomerInfo('city', '', 'addressPost')
                      }
                      style={{
                        width: scaleSzie(22),
                        justifyContent: 'center',
                ...
                >
                  ...
                  {zip ? (
                    <Button
                      onPress={() =>
                        this.updateCustomerInfo('zip', '', 'addressPost')
                      }
                      style={{
                        width: scaleSzie(22),
                        justifyContent: 'center',
              ...
              <FromItem
                ...
                onChangeText={(value) =>
                  this.updateCustomerInfo('referrerBy', value)
                }
              ...
              <PhoneItem
                ...
                upddateCodeArea={(codeReferrerPhone) =>
              ...
              >
                <TextInput
                  ...
                  value={note}
                  onChangeText={(value) =>
                    this.updateCustomerInfo('note', value)
                  }
        ...
        <View
          style={{
            ...
            bottom: 0,
            flexDirection: 'row',
            paddingHorizontal: scaleSzie(45),
            justifyContent: 'space-between',
          }}
        >
          <ButtonCustom
...
const PhoneItem = ({
  ...
  return (
    <View style={[{ marginBottom: scaleSzie(14) }, style]}>
      <Text
        style={{ fontSize: scaleSzie(14), color: '#404040', fontWeight: '600' }}
      >
        {`${title}`}
        {isRequired ? <Text style={{ color: '#FF3B30' }}>{` *`}</Text> : null}
      </Text>
