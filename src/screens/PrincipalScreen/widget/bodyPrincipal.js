...
export default class Layout extends React.Component {
    ...
    render() {
        const { language ,principalInfo,scrollPrincipalTo,dateOfBirth,uriUpload} = this.props;
        const {
