      ...
      <KeyboardAwareScrollView>
        <View style={styles.container}>
          <View style={styles.content}>
            <FormLabelSwitch
              defaultValue={currentAddress?.defaultShippingAddress}
              onValueChange={(value) =>
            ...
            <FormLabelSwitch
              defaultValue={currentAddress?.defaultBillingAddress}
              onValueChange={(value) =>
            ...
            <FormPhoneNumber
              defaultPhone={
                currentAddress?.phone ?? currentAddress?.addressPhone
              }
            ...
            <FormAddress
              ...
              defaultStateValue={
                currentAddress?.state ?? currentAddress?.stateId
              }
              defaultStreetValue={currentAddress?.street}
              defaultCityValue={currentAddress?.city}
              defaultZipCodeValue={
            ...
            <FormFullName
              firstName={
                currentAddress?.firstName ?? currentAddress?.addressFirstName
              }
              lastName={
                currentAddress?.lastName ?? currentAddress?.addressLastName
              }
