...
const apiConfigs = {
    BASE_API: Platform.OS === "ios" ?  env.BASE_API :"https://dev.harmonypayment.com/api/" ,
    BASE_URL: Platform.OS === "ios" ?  env.BASE_URL :"https://dev.harmonypayment.com/" ,
    CALENDAR_URL: Platform.OS === "ios" ?  env.CALENDAR_URL : "https://dev.harmonypayment.com/calendar/index.html",
